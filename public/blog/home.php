    ...
    <div class="main-content home col-9">
      ...
      <div class="background">
        <a href="<?= $data['base_path'] ?>" class="d-flex align-items-center text-dark text-decoration-none">
          <img src="<?= $data['base_path'] ?>/public/imagens/Bem-vindos.png" class="rounded float-start" width="965">
        </a>
      </div>


      <div>
        <h3 class="mt-5 mb-5 rounded-1" style="font-family: 'Times New Roman', Times, serif; color:#664997; background-color:#F8C874; text-align:center;"> Destaques da semana </h3>
      </div>
            ...
            <div class=".post-rodape mt-5 row">
              ...
              <div class="col-8" style="text-align: right;">
                <span class="float-right" style="padding-top: 15px;">
                  ...
                  <a style="color: #664997; text-decoration: none;" href="<?= $data['base_path'] ?>/app/controllers/BlogController.php?action=page_posts_category&category=<?= $post['tag'] ?>">
