...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14-Fev-2023 às 20:43
...
(2, 'Melany Geisell', 'mel.geisell@gmail.com', 'melmel', 'M.G', '2004-02-20', 'comum'),
(3, 'Andrew Payne', 'and.pay@gmail.com', 'paypay', 'A.P', '2004-01-20', 'comum');
...
--
ALTER TABLE `categorias`
  MODIFY `idCategory` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
