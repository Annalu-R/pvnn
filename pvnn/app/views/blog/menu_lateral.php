  ...
  <nav class="menu-lateral rounded-1">
    <div class="pt-6">
      <ul class="nav column">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="<?= $data['base_path']?>">
            <i class="fa-solid fa-house fa-2xs"></i>Início
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link active" href="<?= $data['base_path']?>/app/controllers/BlogController.php?action=page_autora">
            <i class="fa-solid fa-pen-fancy fa-2xs"></i>Autora
          </a>
        </li>
